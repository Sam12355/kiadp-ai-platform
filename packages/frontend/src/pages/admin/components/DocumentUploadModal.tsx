  ...
  return (
    <Portal>
      ...
      >
        ...
        <div 
          className="w-full max-w-lg rounded-[3rem] p-12 shadow-[0_32px_128px_rgba(0,0,0,0.3)] border border-line-strong relative z-10 animate-fade-in overflow-visible" 
        ...
        >
          ...
          <div className="flex justify-between items-center mb-10 border-b border-line pb-8 relative z-20">
            <div className="flex items-center gap-4 text-emerald-700">
              ...
              <h2 className="text-2xl font-black text-ink uppercase tracking-tighter" style={{ fontFamily: 'var(--font-heading)' }}>{t.uploadNew}</h2>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8 relative z-20">
            ...
            <div className="space-y-3">
              <label className="block text-[10px] font-black uppercase tracking-[0.25em] text-ink-mute ml-1">{t.document}</label>
              <label className={`block border-2 border-dashed rounded-[2.5rem] p-12 transition-all group flex flex-col items-center justify-center gap-4 cursor-pointer overflow-hidden bg-raised ${file ? 'border-emerald-500/40' : 'border-line hover:border-emerald-500/30'}`}>
                ...
                {file ? (
                  ...
                  <>
                    <UploadCloud className="w-10 h-10 text-ink-faint group-hover:text-emerald-500 transition-all group-hover:scale-110" />
                    <p className="text-sm font-bold text-ink-mute">{t.uploadNew}</p>
                  </>
                )}
              </label>
            </div>
